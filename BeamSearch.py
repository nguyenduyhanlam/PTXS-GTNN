...
def train(input_tensor, target_tensor, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, max_length=MAX_LENGTH):
    ...
    beam_decode(target_tensor, decoder, decoder_hidden, encoder_outputs)
...
def evaluate(encoder, decoder, sentence, max_length=MAX_LENGTH):
    ...
    with torch.no_grad():
        ...
        beam_decode_evaluate(decoder, decoder_hidden, encoder_outputs)
...
evaluateAndShowAttention("i know all the possibility .")

evaluateAndShowAttention("they kill me .")

evaluateAndShowAttention("let me tell you a story .")